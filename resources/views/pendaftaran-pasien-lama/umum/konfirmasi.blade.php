    ...
    <div class="max-w-4xl mx-auto px-4">
        ...
        <div class="bg-white dark:bg-[#1e2839] rounded-xl border border-gray-200 dark:border-gray-700 shadow-md p-6 md:p-8 transition-colors duration-300 relative">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-300 mt-1">
                Berikut dibawah ini data reservasi yang akan anda lakukan, Klik tombol proses untuk melanjutkan.
            </p>
            ...
            <div class="p-6 md:p-8">
                ...
                <table class="w-full text-sm text-gray-700 dark:text-gray-200">
                    <tbody>
                        ...
                        <tr class="border-b dark:border-gray-700">
                            ...
                            <td class="py-3">: {{ $reservasi ? ($reservasi->cara_bayar ?? 'UMUM') : '-' }}</td>
                        </tr>
                        <tr>
                ...
                <!-- BUTTON -->
                <form id="confirmForm" method="POST" action="{{ route('umum.konfirmasi.post') }}">
                    @csrf
...
<div id="successPopup"
    ...
    <div class="bg-white dark:bg-[#1e2839] text-center p-8 rounded-xl shadow-xl w-[85%] md:w-[40%]">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-300 mb-6">
            Pendaftaran Online Berhasil dilakukan! Sedang diverifikasi oleh petugas.
        </p>

        <button onclick="window.location.href='{{ route('umum.verifikasi')}}'"
...
<script>
    ...
    // Prevent direct submission: if form submits without confirmation, show popup
    if (form) {
    ...
    function showSuccessPopup() {
        confirmPopup.classList.add("hidden");
        // submit confirmation to server for strict matching
