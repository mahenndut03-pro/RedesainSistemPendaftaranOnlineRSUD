...
@section('content')
<h1 class="text-2xl font-bold mb-6">Tambah Poli</h1>
...
<form action="{{ route('poli.store') }}" method="POST"
    ...
    <div class="mb-4">
        ...
        <input type="text" name="kode_poli" value="{{ old('kode_poli') }}" class="w-full border rounded p-2" maxlength="10" />
        @error('kode_poli')
        <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
        @enderror
    </div>
    ...
    <div class="mb-4">
        <label class="inline-flex items-center">
            <input type="checkbox" name="pelayanan_aktif" value="1" class="form-checkbox" checked>
    ...
    <div class="mb-4">
        ...
        <input type="number" name="estimasi_menit" value="{{ old('estimasi_menit', 10) }}" class="w-full border rounded p-2" min="0" />
